  ...
  return (
    <div className="w-full max-w-xl mx-auto">
      ...
      >
        ...
        {tryExamples.map(({ icon: Icon, label }) => (
          <button
            key={label}
            type="button"
            onClick={() => onSearch(label)}
            disabled={isLoading}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors disabled:opacity-50"
          >
